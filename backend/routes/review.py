...
def review_code():
    ...
    try:
        ...
        static_analysis_time = round(static_end - static_start, 2)
        ...
        ai_analysis_time = round(ai_end - ai_start, 2)

        ai_available = isinstance(ai_results, dict) and "error" not in ai_results
        ...
        score_calculation_time = round(score_end - score_start, 2)
        ...
        return jsonify({
            ...
            "ai_feedback": {
                ...
                "error": "AI analysis unavailable" if not ai_available else None
            },
            "score": score,
