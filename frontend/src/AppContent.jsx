  ...
  return (
    <div className="app">
            ...
            <div className="consent-container">
              ...
              <div className="security-warning">
                ...
                <div>
                  ...
                  <p>
                    Do not submit confidential code,
                    API keys, passwords, or personal
                    information.
                  </p>
              ...
              <label className="consent-checkbox">
                ...
                <span>
                  I confirm that this code does not
                  contain confidential or personal
                  information.
                </span>
            ...
            {securityConfirmationRequired && (
              ...
              <div className="security-confirmation">
                ...
                <div className="security-confirmation-content">
                  ...
                  <p>
                    A pattern resembling a secret or
                    credential was detected in your code.
                    Please check your code and make sure it
                    does not contain API keys, passwords,
                    tokens, confidential information or
                    personal data.
                  </p>


                  <p>
                    If you have checked the code and confirm
                    that the detected pattern is not
                    sensitive information, you can continue.
                  </p>
        ...
        {results && (
          ...
          <section className="results-container">
            ...
            <div className="ai-disclaimer">
              ...
              AI suggestions are advisory and should
              be reviewed with project context before
              applying.
      ...
      <footer>
        ...
        <p>
          AI-Assisted Code Review Helper
        </p>

        <p>
          Use this tool for non-sensitive code only
        </p>
