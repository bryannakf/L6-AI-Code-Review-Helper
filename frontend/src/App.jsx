...
function App() {
  ...
  const handleAnalyse = async () => {
    ...
    try {
      ...
      console.log(
        "Analysis took " + analysisTime.toFixed(2) + " seconds"
      );
  ...
  return (
    <div className="app">
      ...
      <p>
        Do not submit confidential code, API keys, passwords or personal
        information.
      </p>
      ...
      <label>
        ...
        I confirm that this code does not contain confidential or personal
        information.
      </label>
        ...
        <div className="results">
          ...
          {results.analysis_time !== undefined && (
            <div className="analysis-time">
              <p>
                ...
                <strong>{results.analysis_time}</strong> seconds
              </p>
            </div>
          )}
          ...
          {results.score && (
            <div className="score-breakdown">
              ...
              <p>
                Readability: {results.score.readability}/100
              </p>

              <p>
                Maintainability: {results.score.maintainability}/100
              </p>

              <p>
                Style: {results.score.style}/100
              </p>

              <p>
                Bugs: {results.score.bugs}/100
              </p>
            </div>
          )}
          ...
          <div className="static-results">
            ...
            <p>
              Tool: {results.static_analysis?.tool}
            </p>
